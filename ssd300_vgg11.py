...
from models.keras_ssd300_vgg11 import ssd_300
...
batch_size = 7 # Change the batch size if you like, or if you run into GPU memory issues.
...
model_checkpoint = ModelCheckpoint(filepath='ssd300_vgg11_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
